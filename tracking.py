...
detector.load_model('/home/minjay/yolov7/runs/train/exp5/weights/best.pt',) # pass the path to the trained weight file

# Initialise  class that binds detector and tracker in one class
tracker = YOLOv7_DeepSORT(reID_model_path="./deep_sort/model_weights/mars-small128.pb", detector=detector)

# output = None will not save the output video
tracker.track_video("/home/minjay/yolov7/sample01.mov", output="./IO_data/output/street.avi", show_live = True, skip_frames = 0, count_objects = True, verbose=1)
